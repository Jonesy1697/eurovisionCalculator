CREATE TABLE country (country VARCHAR(45) NULL , points INT NOT NULL, final BOOLEAN);
ALTER TABLE country ADD PRIMARY KEY(country);

CREATE TABLE people ( name VARCHAR(45) NULL , password VARCHAR(20) NOT NULL, admin BOOLEAN);
